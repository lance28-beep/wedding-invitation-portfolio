          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <form className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-pink-600 text-white px-6 py-3 rounded-md hover:bg-pink-700 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
                >
                  Send Message
                </button>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">info@weddingtemplates.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
